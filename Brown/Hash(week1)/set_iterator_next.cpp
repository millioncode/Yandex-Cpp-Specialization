...
Node* Next(Node* me) {
      ...
      if (me->right != nullptr) {
            me = me->right;
            // спускаеся до самого левого
            while (me->left!=nullptr) me = me->left;
            return me;
      }
      // если нет правого
      else {
            // если me - корень и нет правого
            if (me->parent==nullptr) return nullptr;
            // если мы левый узел без правого
            if (me->parent->left == me) return me->parent;
            // если мы правый узел без правого
            auto ptr = me->parent;
